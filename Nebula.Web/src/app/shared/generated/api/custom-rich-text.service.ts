...
export class CustomRichTextService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public publicCustomRichTextCustomRichTextTypeIDGet(customRichTextTypeID: number, observe?: 'body', reportProgress?: boolean): Observable<CustomRichTextDto>;
    public publicCustomRichTextCustomRichTextTypeIDGet(customRichTextTypeID: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<CustomRichTextDto>>;
    public publicCustomRichTextCustomRichTextTypeIDGet(customRichTextTypeID: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<CustomRichTextDto>>;
    public publicCustomRichTextCustomRichTextTypeIDGet(customRichTextTypeID: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (customRichTextTypeID === null || customRichTextTypeID === undefined) {
            throw new Error('Required parameter customRichTextTypeID was null or undefined when calling publicCustomRichTextCustomRichTextTypeIDGet.');
        }
        ...
        return this.httpClient.get<CustomRichTextDto>(`${this.basePath}/public/customRichText/${encodeURIComponent(String(customRichTextTypeID))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
