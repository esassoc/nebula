...
export const APIS = [CustomPageService, CustomRichTextService, FieldDefinitionService, MenuItemService, RoleService, SystemInfoService, UserService, WatershedService];
